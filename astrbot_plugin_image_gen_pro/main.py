...
from .core.utils import apply_template_variables, validate_aspect_ratio, validate_resolution
...
class ImageGenProPlugin(Star):
    ...
    async def generate_image_command(self, event: AstrMessageEvent):
        ...
        if matched_preset:
            ...
            if extra_content:
                prompt, extra_content = apply_template_variables(prompt, extra_content)
                if extra_content:
